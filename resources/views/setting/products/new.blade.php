               ...
               <div class="bg-white shadow-md rounded my-6 p-5">
                ...
                <div class="grid grid-cols-3 gap-4">
                 ...
                 <div class="flex flex-col space-y-2">
                    ...
                    <input id="small_description" type="text" name="small_description"
                ...
                <div class="form-group" style="margin-right: 3rem;">
                    ...
                    <input type="file" class="form-control" id="exampleInputEmail1"name="image_prod" placeholder="Enter image cat">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input id="taxprod" type="text" name="taxprod" 
                      placeholder="Enter Quantity " class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                </div>
                ...
                <h3 class="flex flex-col space-y-2 ">trending</h3>
                 <div class="grid grid-cols-1 gap-2">
                       <div class="flex flex-col justify-cente">
                           <div class="flex flex-col">
                               <label class="inline-flex items-center mt-3">
                                   <input type="checkbox" class="form-checkbox h-5 w-5 text-blue-600" name="trending" 
                                   ><span class="ml-2 text-gray-700"></span>
                               </label>
                           </div>
                       </div>
