             ...
             <div class="container mx-auto px-6 py-1 pb-16">
               <div class="bg-white shadow-md rounded my-6 p-5">
                 ...
                 <div class="flex flex-col space-y-2">
                     ...
                     <input id="slug" type="text" name="slug"value="{{$cat['slug']}}"
                 ...
                 <div class="flex flex-col space-y-2">
                    ...
                    <input id="description" type="text" name="description"value=" {{$cat['description']}}"
                      ...
                      <div class="flex flex-col justify-cente">
                          <div class="flex flex-col">
                              <label class="inline-flex items-center mt-3">
                                  <input type="checkbox" {{$cat->status== "1" ? 'checked': ''}} class="form-checkbox " name="status" 
                ...
                <h3 class="flex flex-col space-y-2 ">Popular</h3>
                 <div class="grid grid-cols-1 gap-2">
                       <div class="flex flex-col justify-cente">
                           <div class="flex flex-col">
                               <label class="inline-flex items-center mt-3">
                                   <input type="checkbox" {{$cat->popular== '1' ? 'checked' : ''}}class="form-checkbox " name="popular" 
                                   ><span class="ml-2 text-gray-700"></span>
                               </label>
                           </div>
                       </div>
                 ...
                 <div class="flex flex-col space-y-2">
                     ...
                     <input id="meta_title" type="text" name="meta_title" value="{{$cat['meta_title']}}"
                 ...
                 <div class="flex flex-col space-y-2">
                    ...
                    <input id="meta_descrip" type="text" name="meta_descrip" value="{{$cat['meta_descrip']}}"
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input id="meta_keywords" type="text" name="meta_keywords" value="{{$cat['meta_keywords']}}"
                      placeholder="Enter password" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                </div>
